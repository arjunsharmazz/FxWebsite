    ...
    <div className={styles.page}>
      ...
      <section className={styles.features}>
        ...
        <div className={styles.featureGrid}>
          {[
            { title: "Smart Execution", text: "Low-latency order routing..." },
            { title: "Transparent Pricing", text: "No hidden fees..." },
            { title: "Education-First", text: "Live webinars, trading guides..." },
            { title: "Safety by Design", text: "Bank-grade encryption..." }
          ].map((c, i) => (
            <motion.div
              key={c.title}

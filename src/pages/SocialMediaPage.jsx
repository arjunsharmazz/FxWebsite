...
<section className={styles.community}>
  ...
  <div className={styles.communityGrid}>
    <div><FaFacebook /> Facebook Groups</div>
    <div><FaTwitter /> Twitter Spaces</div>
    <div><FaTiktok /> TikTok Live</div>
    <div><FaPinterest /> Pinterest Boards</div>
  </div>
...
<Slider {...testimonialSettings} className={styles.slider}>
  <div className={styles.testimonial}>
    ...
    />
    <p>
      “I joined the India community and found genuine mentors who guided me every step of the way.”
    </p>
    <h4>Anna Smith</h4>
  </div>
  <div className={styles.testimonial}>
    ...
    />
    <p>
      “The Brazil group is full of energy and strategies. I’ve learned more in 6 months here than in 2 years trading alone.”
    </p>
    <h4>David Lee</h4>
  </div>
</Slider>
...
<section className={styles.stories}>
  ...
  <p>
    Real experiences from traders across the globe who grew with
    patience, strategies, and the power of community.
  </p>

  <Slider {...storySettings} className={styles.slider}>
    <div className={styles.storyCard}>
      <img src="https://images.pexels.com/photos/3184396/pexels-photo-3184396.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Brazil Trader" />
    ...
    <div className={styles.storyCard}>
      <img src="https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=600" alt="USA Trader" />
      <div className={styles.storyContent}>
        <h3>Emily Johnson</h3>
    ...
    <div className={styles.storyCard}>
      <img src="https://images.pexels.com/photos/3153201/pexels-photo-3153201.jpeg?auto=compress&cs=tinysrgb&w=600" alt="India Trader" />
      <div className={styles.storyContent}>
        <h3>Rahul Mehta</h3>
        <p className={styles.country}>🇮🇳 India</p>
        <p>
          Turned a $200 account into $20,000 through consistency and
          now mentors others via Telegram.
        </p>
      </div>
    </div>
  </Slider>
